...
var product1 = new product(document.getElementById("p1").value, 12.50, document.getElementById("pr1").value);
var product2 = new product(document.getElementById("p2").value, 10.99, document.getElementById("pr2").value);
var product3 = new product(document.getElementById("p3").value, 15.00, document.getElementById("pr3").value);
var product4 = new product(document.getElementById("p4").value, 18.00, document.getElementById("pr4").value);
var product5 = new product(document.getElementById("p5").value, 9.50, document.getElementById("pr5").value);
